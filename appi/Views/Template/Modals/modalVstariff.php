            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <select class="form-control" data-size="4" data-live-search="true" data-size="5" id="listSec_no" name="listSec_no">
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="txtRemark" name="txtRemark" rows="2" type="text" maxlength="100" required=""></textarea>
                </div>  
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="listPerio2" name="listPerio2" type="number" pattern="[0-9]{4,4}" title="Solo números y maximo 4 digitos" required="">
                    </div>
                </div>
