 <?php
	...
	class VslibstdModel extends Mysql
	{
		...
		public function getLibDetalle(int $secStd, int $perios, string $parcia, string $codigoAMIE)
		{
			$request 		 = array();
			...
			// Extrae definicion de insumos de la tabla: VSTABLES
			$sql = "SELECT SUB_NO,SUB_NM FROM vstables WHERE TAB_NO = 'INS'";
			$request_insumos = $this->select_all($sql);

			// Determina la deuda del estudiante en dicho Parcial
			...
			{
				case 'Q1P1': 
					$QPI = 'v.Q1P1I1,v.Q1P1I2,v.Q1P1I3,v.Q1P1I4,v.Q1P1I5,v.Q1P1PR,';
					break;
				case 'Q1P2':
				 	$QPI = 'v.Q1P2I1,v.Q1P2I2,v.Q1P2I3,v.Q1P2I4,v.Q1P2I5,v.Q1P2PR,';
				 	break;
				case 'Q1P3':
					$QPI = 'v.Q1P3I1,v.Q1P3I2,v.Q1P3I3,v.Q1P3I4,v.Q1P3I5,v.Q1P3PR,';
					break;
				case 'Q1_P':
					$QPI = 'v.Q1P1PR,v.Q1P2PR,v.Q1P3PR,v.Q1P4PR,';
					break;
				case 'Q2P1': 
					$QPI = 'v.Q2P1I1,v.Q2P1I2,v.Q2P1I3,v.Q2P1I4,v.Q2P1I5,v.Q2P1PR,';
					break;
				case 'Q2P2':
					$QPI = 'v.Q2P2I1,v.Q2P2I2,v.Q2P2I3,v.Q2P2I4,v.Q2P2I5,v.Q2P2PR,';
					break;
				case 'Q2P3':
					$QPI = 'v.Q2P3I1,v.Q2P3I2,v.Q2P3I3,v.Q2P3I4,v.Q2P3I5,v.Q2P3PR,';
					break;
				case 'Q2_P':
			...
			$sql = "SELECT e.LAS_NM,e.FIR_NM,s.SEC_NM,s.PARALE,s.JOR_NO,m.MAT_NM,m.CALIFI,
			        ...
			        WHERE v.STD_NO = {$this->intStd_no} AND v.PERIOS = {$this->intPerios}
					ORDER BY t.ORDERS";
		...
		public function insertVslibstd(string $las_nm, string $fir_nm, string $addres, string $tphone, int $idtype, string $ide_no, int $stdgen, string $fecbir, string $stdmai, int $tt_who, string $fatlas, string $fatnam, string $fatadr, string $fatfon, int $fatype, string $fatced, string $fatjob, string $fatbir, string $fatmai, string $motlas, string $motnam, string $motadr, string $motfon, int $motype, string $motced, string $motjob, string $motbir, string $motmai, string $person, string $peradr, string $perfon, int $facwho, string $razons, string $direcc, string $tlf_no, int $cltype, string $ruc_no, string $emails, int $estatu, string $lassch, string $remark)
		{
		}
	}
