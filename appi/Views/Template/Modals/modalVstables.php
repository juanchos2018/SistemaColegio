            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" id="txtSub_no" name="txtSub_no" type="text" placeholder="*" maxlength="5" required="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="listValors">Parámetro Mínimo</label>
                        <input class="form-control" id="listValors" name="listValors" type="number" step="0.01" min="0" required="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="listValor2">Parámetro Máximo</label>
                        <input class="form-control" id="listValor2" name="listValor2" type="number" step="0.01" min="0" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" id="txtSub_nm" name="txtSub_nm" type="text" placeholder="*" maxlength="110" required="">
                    </div>
                </div>
