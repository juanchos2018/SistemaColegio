            ...
            <section id="vscerone" class="invoice">
              ...
              ?>
                  <div class="row mt-4">
                      <div class="col-4 mt-3 text-right">
                        <h2 class="page-header"><img src="<?= media(); ?>images/Jaime.png" style="width: 20%"></h2>
                      </div>

                      <div class="col-4 mt-3 text-center">
                        <h2 class="page-header"><img src="<?= media(); ?>images/jmola.png" style="width: 25%"></h2>
                      </div>

                      <div class="col-4 mt-3 text-left">
                        <h2 class="page-header"><img src="<?= media(); ?>images/Francisca.png" style="width: 20%"></h2>
                      </div>
                  </div>
                  ...
                  <div class="row mt-4" style="font-size: 16px;">                      
                      ...
                      <div class="col-10 offset-1">
                        <p class="text-justify">
                          Previo el cumplimiento de los requisitos legales y reglamentarios se matriculó en el <?= $estudiante[0]['SEC_NM']; ?>  EN ARTE, DEL INSTRUMENTO <?= $estudiante[0]['PARALE']; ?>,  para realizar sus estudios en esta Institución Educativa.
                        </p>
                      </div>
                      <br>
                      <div class="col-10 offset-1">
                        <p class="text-justify">
                          Así consta en el libro de matrículas de la secretaria del plantel, según el Folio Nro. <?= $matricula['FOLNUM'] ?> del <?= $matricula['FECMAT'] ?>. 
                        </p>
                      </div>
                      <br><br><br><br>
                      <div class="col-10 offset-1">
              ...
              ?>
                <div class="row mt-2 text-center">
                     <div class="col-4">
                      <h2 class="page-header"><img src="<?= media(); ?>images/escudo.png" style="width: 65%"></h2>
                    </div>
                ...
                <div class="row mb-0 text-center">
                    ...
                    <div class="col-4"><strong>Régimen: </strong></div>
                </div>

                <div class="row text-center mt-2">
                    <div class="col-12"><h6>DISTRITO EDUCATIVO :  0000</h6></div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 text-justify align-content-center"><p>del <?= $estudiante[0]['SEC_NM']; ?>, especialidad <?= $estudiante[0]['PARALE']; ?>, obtuvo las siguientes calificaciones durante el presente año lectivo</p></div>
                </div>
              ...
              <?php if($proSup != '') { ?>
              <div class="row mt-1">
                <div class="col-12"><p class="align-content-center">Por lo tanto es promovido/a al <strong><?= $proSup?></strong>, ESPECIALIDAD <strong><?= $estudiante[0]['PARALE']; ?></strong></p></div>
              </div>
              <?php } ?>
              ...
              <!-- ----------------------------------------------- -->
                ...
                <div class="row pt-3">
                  <div class="col-6 text-center">
                    <img src="<?= media(); ?>images/gobierno.png" style="width: 55%">
                  </div>
                </div>
