            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control fs_seccion" data-live-search="true" id="listSec_no" name="listSec_no" required="">
                        </select> 
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" onchange="fntStdList();" data-live-search="true" id="listMat_no" name="listMat_no" required="">
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" data-size="6" data-live-search="true" id="listStd_no" name="listStd_no">
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="datFecmax" name="datFecmax" type="date" placeholder="" required="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="listInsumo">Nombre del Insumo *</label>
                                <select class="form-control" id="listInsumo" name="listInsumo" required="">
                                </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="txtPuntaj" name="txtPuntaj" type="text" pattern="[0-9.]{1,6}" placeholder="" maxlength="6" required="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label for="txtMessag">Mensaje de la Actividad</label>
      ...
      <div class="modal-body">
          <table class="table table-bordered table-striped">
              <tbody>
                ...
                <tr>
                  <td class="text-right text-primary">Actividad:</td>
                  <td id="cellActividad"></td>
                </tr>

                <tr>
                  <td class="text-right text-danger">Tarea:</td>
          ...
          <!-- Seccion para Previsualizacion -->
            <form id="formViewStd">
                ...
                <div class="row">
                <div class="form-group col-md-6"> 
                    <label for="flTaskStd" class="text-primary">Actividad del Estudiante</label>
