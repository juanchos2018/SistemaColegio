      ...
      <div class="app-title">
        <div>
          ...
          <?php if($_SESSION['permisosMod']['w']){ ?>
              ...
              <button class="btn btn-primary btnNewVsbillin" type="button" onclick="openModalNcr();"><i class="fas fa-plus-circle"></i> Agregar Nota de Crédito</button>
          <?php } ?>
          <button class="btn btn-warning btnNewVsbillin" type="button" onclick="openModalVen();"><i class="fas fa-plus-circle"></i> Informe Diario Ventas</button>
          </h1>
        </div>
      </div>
