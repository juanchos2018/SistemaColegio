            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="col-lg-12 selectpicker" id="listRegime" name="listRegime" required="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="col-lg-12 selectpicker" id="listCalifi" name="listCalifi" required="">
                                    <option value="" selected>Seleccione</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="col-lg-12 selectpicker" id="listPromed" name="listPromed" required="">
                                    <option value="" selected>Seleccione</option>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label for="listMat_no">Asignatura Grupo</label>
                        <select class="form-control" data-live-search="true" data-size="5" id="listMat_no" name="listMat_no">
                        </select>
                    </div>
                </div>
