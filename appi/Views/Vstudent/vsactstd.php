...
<div class="row">
    <div class="col-md-12">
        ...
        <section id="vsactstd" class="invoice">
            <div class="row pt-2">
                ...
                <div class="col-8 text-left pt-3">
                    <h5 class="mb-0"><?= $empresa['RAZONS'] ?></h5>
                        ...
                        <strong>Email: </strong><?= $empresa['EMAILS'] ?><br>
                        <strong>Teléfono(s): </strong><?= $empresa['TPHONE'] ?><br>
            ...
            <div class="row mt-4 pt-4">
                <div class="col-6 text-center">
                    <address>
                        ...
                        <p class="mb-0" style="font-size: 14px"><strong><?= $empresa['RECTORIA'] ?></strong></p>
                        Rector(a)
                    </address>
                </div>
                ...
                <div class="col-6 text-center">
                    <address>
                        <hr style="border:0.4px solid #dedede;width: 50%" class="mb-1">
                        <p class="mb-0" style="font-size: 14px"><strong><?= $empresa['SECRETARIO'] ?></strong></p>
                        Depto. Secretaría
                    </address>
                </div><br><br><br>
