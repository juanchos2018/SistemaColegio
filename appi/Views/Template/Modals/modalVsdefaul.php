    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Código de Institución y Año Lectivo actual -->
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="txtAmi_id">Código AMIE de Institución *</label>
                        <input class="form-control" id="txtAmi_id" name="txtAmi_id" type="text" placeholder="*" maxlength="10" required="">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="txtRuc_no" name="txtRuc_no" type="text" pattern="[a-zA-Z0-9-]{9,13}" title="Máximo 13 digitos" required="">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="listBascal" name="listBascal" type="number" value="10" min="0" placeholder="*" maxlength="3" required="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="listMinsup">Mímima Calificación Supletorio *</label>
                        <input class="form-control" id="listMinsup" name="listMinsup" type="number" min="0" placeholder="*" maxlength="3" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="listInsnum">Número Máximo de Insumos *</label>
                        <input class="form-control" id="listInsnum" name="listInsnum" type="number" min="0" placeholder="*" maxlength="1" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="listParpor" name="listParpor" type="number" min="0" placeholder="*" maxlength="3" required="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="listExapor">% Ponderación Examen *</label>
                        <input class="form-control" id="listExapor" name="listExapor" type="number" min="0" placeholder="*" maxlength="3" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="listDecnum" name="listDecnum" type="number" value="2" min="0" maxlength="1" required="">
                    </div>
                </div>
