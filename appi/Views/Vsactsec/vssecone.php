...
<main>
  ...
  ?>
                <div class="row mt-1 text-center">
                    <div class="col-4">
                        <h2 class="page-header"><img src="<?= media(); ?>images/escudo.png" style="width: 60%"></h2>
                    </div>
                    ...
                    <div class="col-4 mt-3">
                        <h2 class="page-header"><img src="<?= media(); ?>images/jmola.png" style="width: 20%"></h2>
                    </div>
                </div>
                ...
                <div class="row mt-1">
                    ...
                    <table id="Calificaciones" style="border: 1px black solid;" class="table table-striped table-bordered" cellspacing="0" width="70%">
                        <col style="width: 4%;" />
  <?php
                          if($parcial == "Promedio Final") 
                          {
  ...
  ?>
              <div class="row d-print-none mt-2">
                  <div class="col-12 text-right">
                      <a class="btn btn-warning" onclick="ExportToExcel('<?= $seccion."_".$paralelo."_".$jornada."_".$periodo ?>','xlsx')"><i class="far fa-file-excel"></i> Tabla a EXCEL</a>
