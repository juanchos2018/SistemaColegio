		...
		public function loginUser()
		{
			...
			if($_POST)
			{
				if(empty($_POST['txtUsuario']) || empty($_POST['txtClave']))
				{
					...
					{
						$arrResponse = array('status' => false, 'msg' => 'El usuario o clave son incorrectas','p'=>'login');
					}else{
						$arrData = $requestUser;
						...
						if($arrData['ESTADO'] == 1){
							...
							$arrResponse = array('status' => false, 'msg' => 'Usuario Inactivo','p'=>'login');
						}
					}
				}
