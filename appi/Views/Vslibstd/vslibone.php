...
<main>
  ...
  ?>
              ...
              <div class="row mb-4">
                  <div class="col-md-6">
                      <img src="<?= media(); ?>images/uploads/logo-uens.svg" style="width: 65%">
                  </div>
                  <div class="col-md-6">
                      <h5 class="text-right text-primary mb-0">Fecha Entrega de Boletín</h5>
                      <p class="text-primary text-right"><?= date("d") . "-" . date("M") . "-" . date("Y");  ?></p>
                  </div>
              </div>
