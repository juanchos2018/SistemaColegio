    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header headerRegister">
                <h5 class="modal-title" id="titleModal">Registrar Actas de Calificaciones</h5>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control selectpicker" data-size="5" id="listParci2" name="listParci2" required="">
		    	    			...
		    	    			<option value="Q1_PRO">1º Quimestre - Examen</option>
					    	    ...
					    	    <option value="Q2P3PR">2º Quimestre - 3º Parcial</option>
   							    <option value="Q2_PRO">2º Quimestre - Examen</option>
  			    		</select>
        		    </div>
       		    </div>
